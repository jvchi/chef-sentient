...
export default function ingredientsList(props){
  ...
  return(
    ...
    <section className=' max-w-[800px] flex flex-col justify-around mx-auto  grow h-max'>
        ...
        {props.isIngredients.length >= 4 && <div className='flex flew-row justify-center items-center bg-[#F0EFEB] h-[100px] max-w-[800px] my-8 px-8'>
          <div className='w-full h-[52px] flex flex-col items-center justify-center'>
